...
namespace VidyoConnector
{
    public partial class VideoPage : ContentPage
    {
        ...
        public void Initialize(IVidyoController vidyoController, ICallCenter callCenter)
        {
            this.mVidyoController = vidyoController;
            this.mCallCenter = callCenter;

            _videoView.OnHandleSet = new Command(() => {
                this.mViewModel.ClientVersion = this.mVidyoController.Construct(_videoView, OnCallQuit);
